...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.tabWidget.setGeometry(QtCore.QRect(330, 10, 511, 531))
        ...
        self.gridLayoutWidget_2 = QtWidgets.QWidget(self.DecodeTab)
        ...
        self.Sent_WiSSCI_text = QtWidgets.QTextBrowser(self.NomadTab)
        self.Sent_WiSSCI_text.setGeometry(QtCore.QRect(0, 0, 491, 501))
        self.Sent_WiSSCI_text.setObjectName("Sent_WiSSCI_text")
        self.tabWidget.addTab(self.NomadTab, "")
        self.DecodeTab1 = QtWidgets.QWidget()
        self.DecodeTab1.setObjectName("DecodeTab1")
        self.Recvd_WiSSCI_text = QtWidgets.QTextBrowser(self.DecodeTab1)
        self.Recvd_WiSSCI_text.setGeometry(QtCore.QRect(0, 0, 491, 501))
        self.Recvd_WiSSCI_text.setObjectName("Recvd_WiSSCI_text")
        self.tabWidget.addTab(self.DecodeTab1, "")
        ...
        self.gridLayoutWidget_3.setGeometry(QtCore.QRect(10, 210, 311, 176))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.DecodeTab), _translate("MainWindow", "Configure Decode"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.NomadTab), _translate("MainWindow", "Sent to WiSSCI"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.DecodeTab1), _translate("MainWindow", "WiSSCI Responses"))
